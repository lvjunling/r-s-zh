...
local CAT_ZH_MAP = {
    ["CAT HUB : Blox Fruit"] = "CAT HUB：Blox Fruit",
    ["Created by @catjack.gg"] = "作者：@catjack.gg",
    ["Tab Info And Status"] = "信息与状态",
    ["Tab Farming"] = "刷怪",
    ["Tab Setting"] = "设置",
    ["Tab Fishing"] = "钓鱼",
    ["Tab Quest And Item"] = "任务与物品",
    ["Tab Sea Event"] = "海域事件",
    ["Tab Mirage And Race"] = "幻影岛与种族",
    ["Tab Volcano Event"] = "火山事件",
    ["Tab Stats And Esp"] = "属性与透视",
    ["Tab Fruit And Raid"] = "果实与突袭",
    ["Tab Local Player"] = "本地玩家",
    ["Tab Teleport"] = "传送",
    ["Tab Shopping"] = "商店",
    ["Tab Miscellaneous"] = "杂项",
    ["Information"] = "信息",
    ["CAT HUB | Community"] = "CAT HUB | 社区",
    ["A community for CAT HUB Users - official scripts, updates, and suport in one place."] = "CAT HUB 用户社区：脚本、更新和支持集中在这里。",
    ["Status Server"] = "服务器状态",
    ["Server Time"] = "服务器时间",
    ["Starting..."] = "正在启动...",
    ["Fruit Spawn"] = "果实刷新",
    ...
    ["Auto Farm Nearest"] = "自动刷最近怪物",
    ["Auto Factory Raid"] = "自动工厂突袭",
    ["Auto Pirate Raid"] = "自动海盗突袭",
    ["Auto Farm Ectoplasm"] = "自动刷 Ectoplasm",
    ["Chest"] = "宝箱",
    ["Auto Farm Chest"] = "自动刷宝箱",
    ["Auto Chest Bypass"] = "自动宝箱绕过",
    ["Stop Items"] = "停止物品",
    ["Collect Berry"] = "收集浆果",
    ["Auto Farm Berry"] = "自动刷浆果",
    ["Auto Farm Berry + Hop"] = "自动刷浆果 + 换服",
    ["Farm Mob"] = "刷指定怪",
    ["Select Mob"] = "选择怪物",
    ["Auto Kill Mob"] = "自动击杀怪物",
    ["Farm All Island"] = "刷全岛",
    ["Select Island"] = "选择岛屿",
    ["Auto Farm All Island"] = "自动刷全岛",
    ["Farm Elite Hunter"] = "刷精英猎人",
    ["Elites Process"] = "精英进度",
    ["Elite Spawn"] = "精英刷新",
    ["Auto Farm Elite"] = "自动刷精英",
    ["Auto Farm Elite + Hop"] = "自动刷精英 + 换服",
    ["Farm Rip Indra"] = "刷 Rip Indra",
    ["Auto Attack Rip Indra"] = "自动攻击 Rip Indra",
    ["Auto Unlocked Haki"] = "自动解锁霸气",
    ["Farming Cake"] = "刷蛋糕",
    ["Cake Princes"] = "蛋糕王子进度",
    ["Auto Farm Cake Prince"] = "自动刷蛋糕王子",
    ["Accept Quests"] = "接取任务",
    ["Auto Summon Cake Prince"] = "自动召唤蛋糕王子",
    ["Auto Dough King [Fully]"] = "自动 Dough King [完整]",
    ["Auto Farm Dough King"] = "自动刷 Dough King",
    ["Auto Farm Dough King + Hop"] = "自动刷 Dough King + 换服",
    ["Farming Bone"] = "刷骨头",
    ["Bones"] = "骨头",
    ["Auto Farm Bone"] = "自动刷骨头",
    ["Auto Soul Reaper"] = "自动 Soul Reaper",
    ["Auto Random Bones"] = "自动随机骨头奖励",
    ["Auto Try Luck Gravestone"] = "自动墓碑试运气",
    ["Auto Pray Gravestone"] = "自动墓碑祈祷",
    ["Tyrant of the Skies"] = "天空暴君",
    ["Boss Spawn"] = "Boss 刷新",
    ["Check Status Eyes"] = "检查眼睛状态",
    ["Auto Farm Boss TOTS"] = "自动刷天空暴君 Boss",
    ["Auto Summon Boss"] = "自动召唤 Boss",
    ["Farm Material"] = "刷材料",
    ["Choose Material"] = "选择材料",
    ["Auto Farm Materials"] = "自动刷材料",
    ["Farm Boss"] = "刷 Boss",
    ["Select Boss"] = "选择 Boss",
    ["Auto Farm Boss"] = "自动刷 Boss",
    ["Auto Farm All Boss"] = "自动刷全部 Boss",
    ["Farming Mastery"] = "刷熟练度",
    ["Choose Island"] = "选择岛屿",
    ["Auto Mastery Fruits"] = "自动刷果实熟练度",
    ["Auto Mastery Gun"] = "自动刷枪熟练度",
    ["Auto Mastery All Sword"] = "自动刷全部剑熟练度",
    ["Settings / Configure"] = "设置/配置",
    ["Auto Setting Farm"] = "自动刷怪设置",
    ["Bring Mob"] = "聚怪",
    ["Bypass Teleport"] = "绕过传送限制",
    ["Auto Haki"] = "自动霸气",
    ["Auto Ken"] = "自动见闻色",
    ["Auto Race V3"] = "自动种族 V3",
    ["Auto Race V4"] = "自动种族 V4",
    ["Random Around"] = "随机绕圈",
    ["Safe Mode"] = "安全模式",
    ["Disable Hit VFX"] = "关闭命中特效",
    ["Remove VFX"] = "移除特效",
    ["Disable Notifications"] = "关闭通知",
    ["Auto Collect Chest"] = "自动收集宝箱",
    ["Auto Collect Fruit"] = "自动收集果实",
    ["Stats Upgrade"] = "属性升级",
    ["Auto Stats Melee"] = "自动加点：近战",
    ["Auto Stats Defense"] = "自动加点：防御",
    ["Auto Stats Sword"] = "自动加点：剑",
    ["Auto Stats Gun"] = "自动加点：枪",
    ["Auto Stats Fruit"] = "自动加点：果实",
    ["Fishing"] = "钓鱼",
    ["Select Rod"] = "选择鱼竿",
    ["Select Bait"] = "选择鱼饵",
    ["Auto Buy Bait"] = "自动购买鱼饵",
    ["Auto Fishing"] = "自动钓鱼",
    ["Auto Fishing Quest"] = "自动钓鱼任务",
    ["Auto Sell Fish"] = "自动卖鱼",
    ["Spam Skill Z"] = "连发 Z 技能",
    ["Tushita + Yama"] = "Tushita + Yama",
    ["Skull Guitars / Misc"] = "灵魂吉他/杂项",
    ["Skull Guitar Quests"] = "灵魂吉他任务",
    ["Cursed Dual Katana"] = "诅咒双刀",
    ["Number Cursed dual katana quests"] = "诅咒双刀任务数量",
    ["Quest Numbers :"] = "任务数量：",
    ["True Triple Katana Sword"] = "真三刀",
    ["Pole / God Enal's"] = "Pole / Enel 任务",
    ["Rengoku Sword"] = "炼狱剑",
    ["Cavender + Twin Hooks + Bigmom"] = "Cavender + Twin Hooks + Bigmom",
    ["Buso/Aura Colours"] = "武装色/霸气颜色",
    ["Instinct / Observation"] = "本能/见闻色",
    ["Fighting Melee Styles"] = "近战格斗风格",
    ["Auto Done Bartilo Quest"] = "自动完成 Bartilo 任务",
    ["Auto Done Citizen Quest"] = "自动完成 Citizen 任务",
    ["Auto Training Dummy"] = "自动训练木桩",
    ["Auto Superhuman"] = "自动 Superhuman",
    ["Auto DeathStep"] = "自动 Death Step",
    ["Auto Sharkman Karate"] = "自动 Sharkman Karate",
    ["Auto ElectricClaw"] = "自动 Electric Claw",
    ["Auto DragonTalon"] = "自动 Dragon Talon",
    ["Auto Godhuman"] = "自动 Godhuman",
    ["Auto SanguineArt"] = "自动 Sanguine Art",
    ["Mystic Island / Full Moon"] = "幻影岛/满月",
    ["FullMoon Status"] = "满月状态",
    ["Mirage Island Status"] = "幻影岛状态",
    ["Auto Find Mirage Island"] = "自动寻找幻影岛",
    ["Esp Mirage Island"] = "幻影岛透视",
    ["Auto Tween To Mirage Island"] = "自动移动到幻影岛",
    ["Auto Tween To Highest Point"] = "自动移动到最高点",
    ["Auto Collect Gear"] = "自动收集齿轮",
    ["Change Transparency can see"] = "调整透明度以便观察",
    ["Auto Tween Advanced Fruit Dealer"] = "自动移动到高级果实商人",
    ["Auto Collect Mirage Chest"] = "自动收集幻影岛宝箱",
    ["Talk With Stone"] = "与石头对话",
    ["Auto Look At Moon"] = "自动看向月亮",
    ["Look Moon + Auto V3"] = "看月亮 + 自动 V3",
    ["Upgrade Races V2 And V3"] = "升级种族 V2/V3",
    ["Auto Upgrade Mink"] = "自动升级 Mink",
    ["Auto Upgrade Human"] = "自动升级 Human",
    ["Auto Upgrade Angel"] = "自动升级 Angel",
    ["Auto Upgrade FishMan"] = "自动升级 FishMan",
    ["Trials Quest V4"] = "V4 试炼任务",
    ["Tiers V4 Status"] = "V4 等级状态",
    ["Auto Pull Lever"] = "自动拉杆",
    ["Auto Train V4"] = "自动训练 V4",
    ["Teleport to Temple of Time"] = "传送到时间神殿",
    ["Teleport to Ancient One"] = "传送到 Ancient One",
    ["Teleport to Ancient Clock"] = "传送到远古时钟",
    ["Auto Teleport to Race Doors"] = "自动传送到种族门",
    ["Auto Complete Trial Race"] = "自动完成种族试炼",
    ["Auto Kill Player After Trial"] = "试炼后自动击杀玩家",
    ["Dojo Quest"] = "道场任务",
    ["Auto Dojo Trainer"] = "自动道场训练师",
    ["Auto Dragon Hunter"] = "自动龙猎人",
    ["Tween To Upgrade Droco Trial"] = "移动到 Draco 试炼升级点",
    ["Auto Drago (V1)"] = "自动 Drago (V1)",
    ["Auto Drago (V2)"] = "自动 Drago (V2)",
    ["Auto Drago (V3)"] = "自动 Drago (V3)",
    ["Auto Relic Drago Trial [Beta]"] = "自动 Drago 试炼遗物 [测试]",
    ["Auto Train Drago v4"] = "自动训练 Drago V4",
    ["Tween to Drago Trials"] = "移动到 Drago 试炼",
    ["Swap Drago Race"] = "切换 Drago 种族",
    ["Upgrade Dragon Talon With Uzoth"] = "通过 Uzoth 升级 Dragon Talon",
    ["Volcanic Crafting"] = "火山制作",
    ["Craft Dragonheart"] = "制作 Dragonheart",
    ["Craft Dragonstorm"] = "制作 Dragonstorm",
    ["Craft Dino Hood"] = "制作 Dino Hood",
    ["Craft T-Rex Skull"] = "制作 T-Rex Skull",
    ["Craft Volcanic Magnet"] = "制作火山磁铁",
    ["Prehistoric Island Status"] = "史前岛状态",
    ["Auto Find Prehistoric Island"] = "自动寻找史前岛",
    ["Auto Start Prehistoric Event"] = "自动开始史前岛事件",
    ["Auto Patch Prehistoric Event"] = "自动修补史前岛事件",
    ["Kill Aura"] = "击杀光环",
    ["Auto Collect Dino Bones"] = "自动收集恐龙骨头",
    ["Auto Collect Dragon Eggs"] = "自动收集龙蛋",
    ["Auto Reset When Complete Volcano"] = "火山完成后自动重置",
    ["Remove Lighting Effect"] = "移除光照效果",
    ["Sea Event / Setting Sail"] = "海域事件/航行设置",
    ["Ship Speed Modifier"] = "船速修改",
    ["Ship Speed"] = "船速",
    ["Auto Press W"] = "自动按 W",
    ["No Clip Ship"] = "船只穿墙",
    ["Crafting Items"] = "制作物品",
    ["Craft SharkTooth"] = "制作 SharkTooth",
    ["Craft TerrorJaw"] = "制作 TerrorJaw",
    ["Craft SharkAnchor"] = "制作 SharkAnchor",
    ["Craft LeviathanCrown"] = "制作 Leviathan Crown",
    ["Craft LeviathanShield"] = "制作 Leviathan Shield",
    ["Craft LeviathanBoat"] = "制作 Leviathan Boat",
    ["Craft LegendaryScroll"] = "制作 Legendary Scroll",
    ["Craft MythicalScroll"] = "制作 Mythical Scroll",
    ["Choose Sea Event"] = "选择海域事件",
    ["Select Boats"] = "选择船只",
    ["Buy Boats"] = "购买船只",
    ["Select Sea Level"] = "选择海域等级",
    ["Auto Sail Boat"] = "自动开船",
    ["Entity Sea Event"] = "海域实体事件",
    ["Auto Shark"] = "自动 Shark",
    ["Auto Piranha"] = "自动 Piranha",
    ["Auto Terror Shark"] = "自动 Terror Shark",
    ["Auto Fish Crew Member"] = "自动 Fish Crew Member",
    ["Auto Haunted Crew Member"] = "自动 Haunted Crew Member",
    ["Auto Attack PirateGrandBrigade"] = "自动攻击 PirateGrandBrigade",
    ["Auto Attack Fish Boat"] = "自动攻击 Fish Boat",
    ["Auto Attack Sea Beast"] = "自动攻击 Sea Beast",
    ["Kitsune Island / Event"] = "狐岛/事件",
    ["Kitsune Island Status"] = "狐岛状态",
    ["Auto Find Kitsune Island"] = "自动寻找狐岛",
    ["Auto Teleport to Shrine Actived"] = "自动传送到已激活神社",
    ["Auto Collect Azure Ember"] = "自动收集 Azure Ember",
    ["Auto Trade Azure Ember"] = "自动交易 Azure Ember",
    ["Trade Items Azure"] = "交易 Azure 物品",
    ["Talk with kitsune statue"] = "与狐岛雕像对话",
    ["Frozen Dimension Event"] = "冰冻维度事件",
    ["FrozenDimension Status"] = "冰冻维度状态",
    ["Spy Status"] = "间谍状态",
    ["Buy Spy"] = "购买间谍情报",
    ["Auto Teleport Frozen Dimension"] = "自动传送到冰冻维度",
    ["Auto Drive To Hydra Island"] = "自动驾驶到 Hydra Island",
    ["Auto Attack Leviathan"] = "自动攻击 Leviathan",
    ["Esp"] = "透视",
    ["Esp Berry"] = "浆果透视",
    ["Esp Player"] = "玩家透视",
    ["Esp Chest"] = "宝箱透视",
    ...
    ["Esp Island"] = "岛屿透视",
    ["Esp Flower"] = "花朵透视",
    ["Esp Legendary Sword"] = "传说之剑透视",
    ["Esp Haki Color"] = "霸气颜色透视",
    ["Esp Gear"] = "齿轮透视",
    ["Esp SeaEvent Island"] = "海域事件岛屿透视",
    ["Esp Advanced Dealer"] = "高级商人透视",
    ["Fruits Options"] = "果实选项",
    ["Stock Fruit"] = "库存果实",
    ["Auto Random Fruit"] = "自动随机果实",
    ["Auto Drop Fruit"] = "自动丢弃果实",
    ["Auto Store Fruit"] = "自动存储果实",
    ["Auto Tween to Fruit"] = "自动移动到果实",
    ["Select Fruit Shop"] = "选择果实商店",
    ["Auto Buy Fruit Shop"] = "自动购买商店果实",
    ["Dungeon Event / Raiding"] = "副本事件/突袭",
    ["Select Chip"] = "选择芯片",
    ["Auto Select Dungeon Chip"] = "自动选择副本芯片",
    ["Get Fruit In Inventory Below 1M"] = "获取库存中低于 1M 的果实",
    ["Buy Dungeon Chips [Beli]"] = "购买副本芯片 [贝利]",
    ["Buy Dungeon Chips [Devil Fruit]"] = "购买副本芯片 [恶魔果实]",
    ["Auto Buy Chip [Beli]"] = "自动买芯片 [贝利]",
    ["Auto Buy Chip [Devil Fruit]"] = "自动买芯片 [恶魔果实]",
    ["Auto Start Raid"] = "自动开始突袭",
    ["Auto Raid + Next Island"] = "自动突袭 + 下一岛",
    ["Auto Awakening"] = "自动觉醒",
    ["Auto Teleport To Lab"] = "自动传送到实验室",
    ["Items Law/Order Sword"] = "Law/Order 剑物品",
    ["Buy Microchip Law"] = "购买 Law 微芯片",
    ["Start Law Raids"] = "开始 Law 突袭",
    ["Auto Buy Microchip Law"] = "自动购买 Law 微芯片",
    ["Auto Start Law Raids"] = "自动开始 Law 突袭",
    ["Auto Kill Law"] = "自动击杀 Law",
    ["Raids Dungeons"] = "突袭副本",
    ["Auto Farm Dungeon"] = "自动刷副本",
    ["Combat / AimBot"] = "战斗/自瞄",
    ["All Players On Server"] = "服务器所有玩家",
    ["Aimbot Status"] = "自瞄状态",
    ["Select Players"] = "选择玩家",
    ["Teleport To Select Players"] = "传送到所选玩家",
    ["Spectate Select Players"] = "观察所选玩家",
    ["Select Aim Method"] = "选择瞄准方式",
    ["Aimbot Method Skills"] = "技能自瞄模式",
    ["Aimbot Camera Closet Players"] = "镜头自瞄最近玩家",
    ["Quests Players"] = "玩家任务",
    ["Get player quests"] = "获取玩家任务",
    ["Auto Get PlayerQuest"] = "自动获取玩家任务",
    ["Auto Kill Player Quest"] = "自动击杀玩家任务",
    ["Auto Enable PvP"] = "自动开启 PvP",
    ["Auto Safe Mode"] = "自动安全模式",
    ["LocalPlayer Settings"] = "本地玩家设置",
    ["Enable Fly"] = "启用飞行",
    ["Speed Fly Mode"] = "飞行速度",
    ["Dash No Cooldown"] = "冲刺无冷却",
    ["Instance Mink V3 [ INF ]"] = "Mink V3 无限",
    ["Instance Energy [ INF ]"] = "能量无限",
    ["Instance Soru [ INF ]"] = "Soru 无限",
    ["Instance Observation Range [ INF ]"] = "见闻色范围无限",
    ["Ignore Same Teams"] = "忽略同队",
    ["Accept Allies"] = "接受盟友",
    ["Travel - Worlds"] = "传送 - 世界",
    ["Travel East Blue (World 1)"] = "前往 East Blue（世界 1）",
    ["Travel Dressrosa (World 2)"] = "前往 Dressrosa（世界 2）",
    ["Travel Zou (World 3)"] = "前往 Zou（世界 3）",
    ["Travel - Island"] = "传送 - 岛屿",
    ["Select Travelling"] = "选择传送点",
    ["Auto Travel"] = "自动传送",
    ["Travel - Portal"] = "传送 - 传送门",
    ["Select Portal"] = "选择传送门",
    ["Travel - NPCs"] = "传送 - NPC",
    ["Select NPCs"] = "选择 NPC",
    ["Auto Tween to NPC"] = "自动移动到 NPC",
    ["Shop Options"] = "商店选项",
    ["Buy Buso"] = "购买武装色",
    ["Buy Geppo"] = "购买月步",
    ["Buy Soru"] = "购买 Soru",
    ["Buy Ken"] = "购买见闻色",
    ["Fighting - Style"] = "格斗风格",
    ["Buy Black Leg"] = "购买 Black Leg",
    ["Buy Electro"] = "购买 Electro",
    ["Buy Fishman Karate"] = "购买 Fishman Karate",
    ["Buy DragonClaw"] = "购买 Dragon Claw",
    ["Buy Superhuman"] = "购买 Superhuman",
    ["Buy Death Step"] = "购买 Death Step",
    ["Buy Sharkman Karate"] = "购买 Sharkman Karate",
    ["Buy ElectricClaw"] = "购买 Electric Claw",
    ["Buy DragonTalon"] = "购买 Dragon Talon",
    ["Buy Godhuman"] = "购买 Godhuman",
    ["Buy SanguineArt"] = "购买 Sanguine Art",
    ["Accessory"] = "饰品",
    ["Fragments shop"] = "碎片商店",
    ["Buy Refund Stats"] = "购买属性重置",
    ["Buy Reroll Race"] = "购买重随机种族",
    ["Buy Ghoul Race"] = "购买 Ghoul 种族",
    ["Buy Cyborg Race (2.5k)"] = "购买 Cyborg 种族 (2.5k)",
    ["Buy Draco Race"] = "购买 Draco 种族",
    ["Server - Function"] = "服务器功能",
    ["Redeem All Codes"] = "兑换所有代码",
    ["Rejoin Server"] = "重进服务器",
    ["Hop Server"] = "换服",
    ["Hop to Lowest Players"] = "换到人数最少服务器",
    ["Hop to Lowest Pings Server"] = "换到低延迟服务器",
    ["Input Job Id"] = "输入 JobId",
    ["Teleport [Job ID]"] = "传送 [Job ID]",
    ["Copy JobID"] = "复制 JobID",
    ["Manual Hop"] = "手动换服",
    ["No different public server was found."] = "没有找到其他公开服务器。",
    ["Joining another server..."] = "正在加入其他服务器...",
    ["Server hop failed."] = "换服失败。",
    ["Player Gui / Others"] = "玩家界面/其他",
    ["Open Awakenings Expert"] = "打开觉醒专家",
    ["Open Title Selection"] = "打开称号选择",
    ["Disable Chat GUI"] = "关闭聊天界面",
    ["Disable Leader Board GUI"] = "关闭排行榜界面",
    ["Set Pirate Team"] = "切换海贼队",
    ["Set Marine Team"] = "切换海军队",
    ["Unlock All Portals"] = "解锁所有传送门",
    ["Graphics / Haki Stats"] = "画质/霸气状态",
    ["Select Haki States"] = "选择霸气阶段",
    ["ChangeBusoStage"] = "切换武装色阶段",
    ["Turn on RTX Mode"] = "开启 RTX 模式",
    ["Turn on Fast Mode"] = "开启快速模式",
    ["Turn on Low CPU"] = "开启低 CPU 模式",
    ["Turn on increase Boats"] = "开启船只增强",
    ["Remove Sky Fog"] = "移除天空雾气",
    ["Configure - God"] = "配置 - God",
    ["Rain Fruits (Client)"] = "果实雨（客户端）",
    ["Turn on Full Bright"] = "开启全亮",
    ["Select Time"] = "选择时间",
    ["Turn on Time"] = "启用时间",
    ["Turn on Walk on Water"] = "开启水上行走",
    ["Turn on Ice Walk"] = "开启冰上行走",
    ["Smart Server Hop"] = "智能换服",
    ["Near Full Moon Hop"] = "近满月换服",
    ["Mirage Island Hop"] = "幻影岛换服",
    ["Prehistoric Island Hop"] = "史前岛换服",
    ["Fruit Spawn Hop"] = "果实刷新换服",
    ["Copy Current JobId"] = "复制当前 JobId",
    ["Stop Server Hop"] = "停止换服",
    ["Hop until a near-full-moon server is found, then copy its JobId."] = "换服直到找到接近满月的服务器，然后复制 JobId。",
    ["Hop until Mirage Island is detected, then copy the JobId."] = "换服直到检测到幻影岛，然后复制 JobId。",
    ["Hop until Prehistoric Island is detected, then copy the JobId."] = "换服直到检测到史前岛，然后复制 JobId。",
    ["Hop until a fruit is detected in the current server, then copy the JobId."] = "换服直到当前服务器检测到果实，然后复制 JobId。",
    ["Copy the current server JobId."] = "复制当前服务器的 JobId。",
    ["Stop the active smart server search."] = "停止当前智能服务器搜索。",
    ["Server Hop"] = "换服",
    ["A server search is already running."] = "服务器搜索已经在运行。",
    ["Searching"] = "正在搜索",
    ["Suitable Server Found"] = "找到合适服务器",
    ["No Server"] = "没有服务器",
    ["No suitable public server was found."] = "没有找到合适的公开服务器。",
    ["Hop Failed"] = "换服失败",
    ["Could not join the selected server. Retrying..."] = "无法加入所选服务器，正在重试...",
    ["Search Ended"] = "搜索结束",
    ["No suitable server found after 25 attempts."] = "尝试 25 次后仍未找到合适服务器。",
    ["Server search stopped."] = "服务器搜索已停止。",
    ["JobId is unavailable."] = "JobId 不可用。",
    ["JobId Copied"] = "JobId 已复制",
    ["Suitable server JobId copied:"] = "合适服务器的 JobId 已复制：",
    ["Suitable server:"] = "合适服务器：",
    ["CAT hub da comeback"] = "CAT HUB 已加载",
}

local function CAT_ZH_TEXT(value)
    if type(value) ~= "string" then
        return value
    end

    local function plainPattern(text)
        return (text:gsub("([^%w])", "%%%1"))
    end

    local result = value
    for from, to in pairs(CAT_ZH_MAP) do
        result = result:gsub(plainPattern(from), to)
    end
    result = result:gsub("Searching for (.-) server%.%.%.", "正在搜索 %1 服务器...")
    result = result:gsub("No (.-) here%.%s*Finding another server%.%.%. %((%d+)/25%)", "这里没有 %1。正在寻找另一个服务器...（%2/25）")
    result = result:gsub("(.-) found!%s*Server: (.-)%s*JobId: (.+)", "已找到 %1！\n服务器：%2\nJobId：%3")
    return result
end

local function CAT_ZH_TABLE(tbl)
    ...
    for key, value in pairs(tbl) do
        if type(value) == "table" and key ~= "Options" and key ~= "Default" then
            result[key] = CAT_ZH_TABLE(value)
        elseif (key == "Title" or key == "SubTitle" or key == "Name" or key == "Description" or key == "Content" or key == "Text") and type(value) == "string" then
            result[key] = CAT_ZH_TEXT(value)
        else
            result[key] = value
        end
    end
...
local function CAT_WRAP_TAB(tab)
    if type(tab) ~= "table" or tab.__CAT_ZH_WRAPPED then
        return tab
    end
    tab.__CAT_ZH_WRAPPED = true

    for _, methodName in ipairs({"AddSection", "AddParagraph"}) do
        ...
        if type(original) == "function" then
            tab[methodName] = function(self, ...)
                ...
                for index, value in ipairs(args) do
                    if type(value) == "string" then
                        args[index] = CAT_ZH_TEXT(value)
                    elseif type(value) == "table" then
                        args[index] = CAT_ZH_TABLE(value)
                    end
                end
    ...
    for _, methodName in ipairs({"AddButton", "AddToggle", "AddDropdown", "AddSlider", "AddTextbox", "AddDiscordInvite"}) do
        local original = tab[methodName]
        if type(original) == "function" then
            tab[methodName] = function(self, data, ...)
                return original(self, CAT_ZH_TABLE(data), ...)
            end
        end
    end
...
local originalMakeWindow = redzlib.MakeWindow
redzlib.MakeWindow = function(self, data, ...)
    local window = originalMakeWindow(self, CAT_ZH_TABLE(data), ...)

    if type(window) == "table" and not window.__CAT_ZH_WRAPPED then
        window.__CAT_ZH_WRAPPED = true

        local originalMakeTab = window.MakeTab
        if type(originalMakeTab) == "function" then
            window.MakeTab = function(winSelf, tabData, ...)
                return CAT_WRAP_TAB(originalMakeTab(winSelf, CAT_ZH_TABLE(tabData), ...))
            end
        end

        for _, methodName in ipairs({"Notify", "MakeNotification", "Dialog"}) do
            local original = window[methodName]
            if type(original) == "function" then
                window[methodName] = function(winSelf, notifyData, ...)
                    return original(winSelf, CAT_ZH_TABLE(notifyData), ...)
                end
            end
        end
    end
