...
local Z= "TurokHub_FlightSpeed.txt"
local z= "TurokHub_EggSelectConfig.json"
...
local function T(...)
    ...
    if type(e)~= "table" then
        ...
        if e.language and((e.language == "EN" or e.language == "TH" or e.language == "ZH" ))then
...
local function Mk(...) h.performanceMode = true pcall(function(...)
        local e=r:FindFirstChild( "TurokHub_EggESP" )
        if e then
            e:Destroy()
        end
...
[ "Disable3DStarted" ]= "3D Rendering disabled (GPU Saver Active)" ,[ "Disable3DStopped" ]= "3D Rendering restored" ,[ "AntiAFKStarted" ]= "Anti-AFK enabled (Double-Esc 10m & Mobile support)" ,[ "AntiAFKStopped" ]= "Anti-AFK disabled" ,[ "LangSwitched" ]= "Language switched to English successfully!" }},[ "ZH" ]={
[ "StatusTagReady" ]= "状态：就绪",
[ "Tabs" ]={[ "Farm" ]= "自动收集",[ "EggSelect" ]= "鸡蛋筛选",[ "Character" ]= "角色",[ "Settings" ]= "设置"},
[ "EggSelect" ]={
[ "SecZones" ]= "目标区域",[ "SecZonesDesc" ]= "选择普通鸡蛋的目标区域（Secret 及以上不受区域筛选限制）",
[ "DropZonesTitle" ]= "已选区域",[ "DropZonesDesc" ]= "点击选择要收集鸡蛋的区域",
[ "SecRarities" ]= "目标稀有度",[ "SecRaritiesDesc" ]= "选择目标鸡蛋的稀有度",
[ "DropRaritiesTitle" ]= "已选稀有度",[ "DropRaritiesDesc" ]= "点击选择要收集的稀有度",
[ "AlwaysSecretPlus" ]= "始终收集 Secret+ 鸡蛋",[ "AlwaysSecretPlusDesc" ]= "自动收集任意区域的 Secret、Eternal、Divine 鸡蛋"},
[ "Farm" ]={
[ "SecModes" ]= "自动偷蛋模式",[ "TweenTitle" ]= "自动偷蛋（平滑飞行）",[ "TweenDesc" ]= "沿高速安全路线持续飞向目标并收集鸡蛋",
[ "TeleportTitle" ]= "自动偷蛋（传送）",[ "TeleportDesc" ]= "快速传送并持续收集鸡蛋",
[ "SingleTitle" ]= "单次偷蛋（传送）",[ "SingleDesc" ]= "传送收集一个目标鸡蛋并返回基地",
[ "SecPlace" ]= "放置与孵化",[ "PlaceTitle" ]= "放置鸡蛋",[ "PlaceDesc" ]= "返回基地，将背包鸡蛋放入空孵化台并请求孵化",
[ "AutoPlaceTitle" ]= "自动放置（每5个）",[ "AutoPlaceDesc" ]= "每收集5个鸡蛋自动返回基地存放",
[ "HatchTitle" ]= "自动孵化",[ "HatchDesc" ]= "随时持续孵化已准备好的鸡蛋",
[ "ReturnTitle" ]= "自动返回",[ "ReturnDesc" ]= "偷蛋后自动飞回安全区域",
[ "AutoTreadmillTitle" ]= "自动跑步机",[ "AutoTreadmillDesc" ]= "没有目标鸡蛋时自动使用基地跑步机",
[ "UpgradeTreadmillTitle" ]= "自动升级跑步机",[ "UpgradeTreadmillDesc" ]= "资金足够时自动升级基地跑步机",
[ "BuyTrailsTitle" ]= "自动购买并装备尾迹",[ "BuyTrailsDesc" ]= "自动购买并装备最佳速度尾迹",
[ "HideNotEnoughMoneyTitle" ]= "隐藏“资金不足”提示",[ "HideNotEnoughMoneyDesc" ]= "自动隐藏游戏中的红色资金不足提示"},
[ "Character" ]={
[ "SecSafety" ]= "角色与安全",[ "GodmodeTitle" ]= "无敌模式",[ "GodmodeDesc" ]= "抵御地图障碍、陷阱和危险",
[ "UnstickTitle" ]= "解除卡住",[ "UnstickDesc" ]= "立即脱离跑步机、座椅或地图结构",
[ "SecFlight" ]= "飞行设置",[ "SpeedTitle" ]= "飞行速度",[ "SpeedDesc" ]= "调整巡航飞行速度（Stud/秒）"},
[ "Settings" ]={
[ "SecDashboard" ]= "实时状态",[ "DashTitle" ]= "实时状态",
[ "DashDesc" ]= "状态：%s\n收集模式：%s\n携带鸡蛋：%d\n飞行速度：%d Stud/秒",
[ "SecBlacklist" ]= "区域偏好",[ "BlacklistToggleTitle" ]= "目标区域：%s",[ "BlacklistToggleDesc" ]= "启用 %s 区域的普通鸡蛋收集（Secret+ 始终收集）",
[ "SecUI" ]= "界面设置",[ "TranspTitle" ]= "窗口透明度",[ "TranspDesc" ]= "调整界面背景透明度（0%-90%）",[ "ThemeTitle" ]= "选择主题",
[ "SecPerformance" ]= "性能与画面",[ "PerformanceTitle" ]= "极限性能模式",[ "PerformanceDesc" ]= "关闭纹理、网格、灯光、阴影、特效和粒子以提高帧率",
[ "Disable3DTitle" ]= "关闭3D渲染（节省GPU 95%）",[ "Disable3DDesc" ]= "暂停3D画面渲染，大幅降低GPU占用，适合长时间挂机",
[ "LangTitle" ]= "语言",[ "BtnTranslate" ]= "切换语言",[ "DescTranslate" ]= "切换界面语言",
[ "SecSystem" ]= "系统控制",[ "AntiAFKTitle" ]= "防挂机（双Esc/手机支持）",[ "AntiAFKDesc" ]= "每10分钟双Esc脉冲，并发送手机触摸或PC抖动输入",
[ "ResetTitle" ]= "重置角色状态",[ "ResetDesc" ]= "清除内部状态并恢复角色移动",
[ "RejoinTitle" ]= "重新加入服务器",[ "RejoinDesc" ]= "重新连接当前服务器",
[ "UnloadTitle" ]= "卸载脚本",[ "UnloadDesc" ]= "停止全部循环并关闭界面"},
[ "Notifications" ]={
[ "PlaceStarted" ]= "正在返回基地放置鸡蛋……",[ "PlaceDone" ]= "鸡蛋已放入孵化台并请求孵化！",
[ "AutoPlaceStarted" ]= "已开启自动放置（每5个）",[ "AutoPlaceStopped" ]= "已关闭自动放置",
[ "NoEggFound" ]= "当前没有符合筛选条件的鸡蛋",[ "UnstickDone" ]= "解除卡住指令已发送！",
[ "TweenStarted" ]= "已开启自动偷蛋（平滑飞行）",[ "TweenStopped" ]= "已关闭自动偷蛋（平滑飞行）",
[ "TeleportStarted" ]= "已开启自动偷蛋（传送）",[ "TeleportStopped" ]= "已关闭自动偷蛋（传送）",
[ "HatchStarted" ]= "已开启自动孵化",[ "HatchStopped" ]= "已关闭自动孵化",
[ "ReturnStarted" ]= "已开启自动返回",[ "ReturnStopped" ]= "已关闭自动返回",
[ "AutoTreadmillStarted" ]= "已开启自动跑步机（空闲时运行）",[ "AutoTreadmillStopped" ]= "已关闭自动跑步机",
[ "UpgradeTreadmillStarted" ]= "已开启自动升级跑步机",[ "UpgradeTreadmillStopped" ]= "已关闭自动升级跑步机",
[ "BuyTrailsStarted" ]= "已开启自动购买尾迹",[ "BuyTrailsStopped" ]= "已关闭自动购买尾迹",
[ "HideNotEnoughMoneyStarted" ]= "已隐藏资金不足提示",[ "HideNotEnoughMoneyStopped" ]= "已恢复资金不足提示",
[ "GodmodeStarted" ]= "已开启无敌模式",[ "GodmodeStopped" ]= "已关闭无敌模式",
[ "PerformanceStarted" ]= "已开启极限性能模式（已移除纹理和特效）",[ "PerformanceStopped" ]= "已关闭极限性能模式",
[ "Disable3DStarted" ]= "已关闭3D渲染（GPU节省模式生效）",[ "Disable3DStopped" ]= "已恢复3D渲染",
[ "AntiAFKStarted" ]= "已开启防挂机（双Esc/手机支持）",[ "AntiAFKStopped" ]= "已关闭防挂机",
[ "LangSwitched" ]= "界面已切换为中文！"}},[ "TH" ]={[ "StatusTagReady" ]= "สถานะ: พร้อมทำงาน" ,[ "Tabs" ]={[ "Farm" ]= "ระบบฟาร์ม" ;
...
local function Wk(e,...)
    local th=(e== "TH")
    local zh=(e== "ZH")
    local function L(cn,thai,en)
        if zh then return cn elseif th then return thai else return en end
    end
    if h.delivering then
        return L("正在放置鸡蛋","กำลังวางไข่","Placing Egg")
    elseif h.securingEgg or h.holdingEggForGuard then
        return L("正在拾取鸡蛋","กำลังหยิบไข่","Securing Egg")
    elseif h.teleporting then
        return L("正在传送","กำลังวาร์ป","Teleporting")
    elseif h.isReturning then
        return L("正在返回","กำลังบินกลับ","Returning")
    elseif h.glidingToTarget then
        return L("正在偷蛋","กำลังบินไปขโมย","Stealing")
    elseif h.onTreadmill or(L4 and L4())then
        return L("正在使用跑步机","อยู่บนลู่วิ่ง","On Treadmill")
    elseif (Y4== "TWEEN" or Y4== "WARP") and not h.isReturning then
        return L("正在寻找鸡蛋","กำลังหาไข่","Searching")
    else
        return L("就绪","พร้อมทำงาน","Ready")
    end
end
...
local function rM(e,r,y,...) pcall(function(...)
        ...
        if u and u:IsA( "GuiObject" )then
            ...
            local j=u:FindFirstChild( "TurokAccentStroke" )or u:FindFirstChildOfClass( "UIStroke" )
            if j then
                j:Destroy()
            end
...
local function jM(...)
    local e=Instance.new ( "ScreenGui" )e.Name = "Turok_LOADER_SCREEN" e.ResetOnSpawn = false e.DisplayOrder = 9999999 e.ZIndexBehavior =Enum.ZIndexBehavior.Sibling e.AutoLocalize = false pcall(function(...)
    ...
    local w=Instance.new ( "TextLabel" )w.Size =UDim2.new ( 1 , -28 , 0 , 24 )w.Position =UDim2.new ( 0 , 14 , 0 , 14 )w.BackgroundTransparency = 1 w.Text = "Turok Hub" w.TextColor3 =Color3.fromRGB ( 245 , 248 , 255 )w.TextSize = 18 w.Font =Enum.Font.GothamBold w.TextXAlignment =Enum.TextXAlignment.Left w.AutoLocalize = false w.Parent =r
    local j=Instance.new ( "TextLabel" )j.Size =UDim2.new ( 1 , -28 , 0 , 16 )j.Position =UDim2.new ( 0 , 14 , 0 , 38 )j.BackgroundTransparency = 1 j.Text = "偷蛋套件 v42.64" j.TextColor3 =Color3.fromRGB ( 140 , 150 , 175 )j.TextSize = 12 j.Font =Enum.Font.Gotham j.TextXAlignment =Enum.TextXAlignment.Left j.AutoLocalize = false j.Parent =r
    ...
    local t=Instance.new ( "TextLabel" )t.Size =UDim2.new ( 1 , -28 , 0 , 16 )t.Position =UDim2.new ( 0 , 14 , 0 , 94 )t.BackgroundTransparency = 1 t.Text = "正在初始化 Turok Hub……" t.TextColor3 =Color3.fromRGB ( 130 , 140 , 165 )t.TextSize = 11 t.Font =Enum.Font.Gotham t.TextXAlignment =Enum.TextXAlignment.Left t.AutoLocalize = false t.Parent =r task.spawn (function(...)
        for y= 1 , 100 , 1 do
            if not e.Parent then
                break
            end
...
local kM={}kM.Gui =Instance.new ( "ScreenGui" )kM.Gui.Name = "Turok_RESTORE_BAR" kM.Gui.ResetOnSpawn = false kM.Gui.DisplayOrder = 999999 kM.Gui.ZIndexBehavior =Enum.ZIndexBehavior.Sibling kM.Gui.AutoLocalize = false pcall(function(...)
    if syn and syn.protect_gui then
...
local function aM(...) h.alive = false pcall(Ik)pcall(Ak)pcall(function(...) y:Set3dRenderingEnabled( true )
        ...
        local y=r:FindFirstChild( "TurokHub_EggESP" )
        if y then
            y:Destroy()
        end
    end
    ...
    pcall(function(...)
        for r,y in ipairs(game.CoreGui :GetChildren())do
            if y.Name :find( "Turok_" )or y.Name :find( "DesyncSniperUI" )or y.Name :find( "WindUI" )then
                y:Destroy()
            end
        end
    end
...
local function oM(...)
    ...
    local function j(e,...)
        ...
        if not y then
            pcall(function(...)
                (game:GetService( "StarterGui" )):SetCore( "SendNotification" ,{[ "Title" ]=tostring(e.Title or "Turok Hub" ),[ "Text" ]=tostring(e.Content or "" );
                [ "Duration" ]= 3 })
            end
            )
        end
    ...
    if r then
        pcall(function(...)
            ...
            if e then
                r.Notify =function(r,y,...)
                    ...
                    if not u then
                        pcall(function(...)
                            (game:GetService( "StarterGui" )):SetCore( "SendNotification" ,{[ "Title" ]=tostring(y and y.Title or "Turok Hub" );
        ...
        local p=r:CreateWindow({[ "Title" ]= "Turok Hub" ;
        [ "Author" ]= "Steal An Egg V1" ;
        [ "Folder" ]= "Turok_StealAnEgg" ;
        [ "Icon" ]=dk;
        ...
        })Fk.togAutoPlaceEvery5 =hk:Toggle({[ "Title" ]=P.Farm.AutoPlaceTitle or "自动放置（每5个）" ;
        [ "Desc" ]=P.Farm.AutoPlaceDesc or "每收集5个返回基地放置并等待5秒" ;
        ...
        [ "Callback" ]=function(e,...) h.autoPlaceEvery5 =e
            ...
            local r=Gk[Xk]or Gk.EN j({[ "Title" ]= "自动放置（每5个）" ,[ "Content" ]=e and((r.Notifications.AutoPlaceStarted or "Auto Place (Every 5) enabled" ))or(r.Notifications.AutoPlaceStopped or "Auto Place (Every 5) disabled" ),[ "Icon" ]=e and "check-circle" or "x-circle" })
        end
        })Fk.togAutoHatch =hk:Toggle({[ "Title" ]=P.Farm.HatchTitle ;
        [ "Desc" ]=P.Farm.HatchDesc ,[ "Icon" ]= "solar:star-bold" ;
        [ "Value" ]=h.autoHatch ,[ "Callback" ]=function(e,...) h.autoHatch =e j({[ "Title" ]= "自动孵化" ,[ "Content" ]=e and Gk[Xk].Notifications.HatchStarted or Gk[Xk].Notifications.HatchStopped ,[ "Icon" ]=e and "check-circle" or "x-circle" })
        end
        ...
        [ "Callback" ]=function(e,...) h.autoGlide =e j({[ "Title" ]= "自动返回" ;
            [ "Content" ]=e and Gk[Xk].Notifications.ReturnStarted or Gk[Xk].Notifications.ReturnStopped ;
            [ "Icon" ]=e and "check-circle" or "x-circle" })
        end
        })Fk.togAutoTreadmill =hk:Toggle({[ "Title" ]=P.Farm.AutoTreadmillTitle or "自动跑步机" ;
        [ "Desc" ]=P.Farm.AutoTreadmillDesc or "没有目标鸡蛋时使用基地跑步机" ;
        ...
        [ "Callback" ]=function(e,...) h.autoTreadmill =e x()n4()
            ...
            local r=Gk[Xk]or Gk.EN j({[ "Title" ]= "自动跑步机" ;
        ...
        [ "Callback" ]=function(e,...)
            if e then
                enableDesyncGodmode()j({[ "Title" ]= "无敌模式" ,[ "Content" ]=Gk[Xk].Notifications.GodmodeStarted ,[ "Icon" ]= "shield-check" })
            else
                disableDesyncGodmode()j({[ "Title" ]= "无敌模式" ,[ "Content" ]=Gk[Xk].Notifications.GodmodeStopped ,[ "Icon" ]= "shield-off" })
            end
        end
        ...
        [ "Desc" ]=string.format ( "状态：就绪\n收集模式：空闲\n携带鸡蛋：0\n飞行速度：%d Stud/秒" ,h.glideSpeed or 600 )})Fk.secUI =Tk:Section({[ "Title" ]=P.Settings.SecUI })Fk.dropLang =Tk:Dropdown({[ "Title" ]=P.Settings.LangTitle ,[ "Values" ]={ "中文" , "English" , "ไทย" },[ "Value" ]=(Xk== "ZH" and "中文" or (Xk== "EN" and "English" or "ไทย" )),[ "Callback" ]=function(e,...)
            local r=(e== "中文" and "ZH" or ((e== "ไทย" )and "TH" or "EN"))
            if r~=Xk then
                Xk=r currentLang=r wM(Xk)pcall(x)j({[ "Title" ]=(Xk== "ZH" and "语言" or ((Xk== "TH" )and "ภาษา" or "Language")) ,[ "Content" ]=Gk[Xk].Notifications.LangSwitched ,[ "Icon" ]= "check-circle" })
            end
        end
            ...
            while h.alive do
                pcall(function(...)
                    ...
                    if B then
                        ...
                        pcall(function(...)
                            if B.SetTitle then
                                B:SetTitle(((z and "状态：" or (y and "สถานะ: " or "Status: " )))..u)
                            end
                            if B.SetColor then
                                B:SetColor(e)
                            end
                    ...
                    if Fk.paraLiveDash and Fk.paraLiveDash.SetDesc then
                        local e=z and "空闲" or (y and "หยุดพัก" or "Idle")
                        if Y4== "TWEEN" then
                            e=z and "自动偷蛋（平滑飞行）" or (y and "ขโมยไข่ (บินเร็ว)" or "自动偷蛋（平滑飞行）")
                        elseif Y4== "WARP" then
                            e=z and "自动偷蛋（传送）" or (y and "ขโมยไข่ (วาร์ป)" or "自动偷蛋（传送）")
                        end
                        local j=z and "状态：%s\n收集模式：%s\n携带鸡蛋：%d\n飞行速度：%d Stud/秒" or (y and "สถานะ: %s\nโหมดฟาร์ม: %s\nจำนวนไข่ในตัว: %d ฟอง\nความเร็วบิน: %d Studs/s" or "Status: %s\nFarm Mode: %s\nCarried Eggs: %d\nFlight Speed: %d Studs/s")
    ...
    local l=Instance.new ( "TextLabel" )l.Size =UDim2.new ( 1 , -90 , 0 , 22 )l.Position =UDim2.new ( 0 , 12 , 0 , 6 )l.BackgroundTransparency = 1 l.Text = "Turok Hub（备用界面）" l.TextColor3 =B l.TextSize = 14 l.Font =Enum.Font.GothamBold l.TextXAlignment =Enum.TextXAlignment.Left l.AutoLocalize = false l.Parent =U
    local D=Instance.new ( "TextLabel" )D.Size =UDim2.new ( 1 , -90 , 0 , 14 )D.Position =UDim2.new ( 0 , 12 , 0 , 26 )D.BackgroundTransparency = 1 D.Text = "偷蛋套件 v42.64" D.TextColor3 =Color3.fromRGB ( 0 , 255 , 160 )D.TextSize = 11 D.Font =Enum.Font.Gotham D.TextXAlignment =Enum.TextXAlignment.Left D.AutoLocalize = false D.Parent =U
    ...
    local function A(e,r,y,u,w,...)
        ...
        local o=Instance.new ( "TextButton" )o.Size =UDim2.new ( 0 , 78 , 0 , 30 )o.Position =UDim2.new ( 1 , -86 , 0.5 , -15 )o.BackgroundColor3 =y o.Text = "执行" o.TextColor3 =Color3.fromRGB ( 255 , 255 , 255 )o.TextSize = 11 o.Font =Enum.Font.GothamBold o.AutoButtonColor = false o.Parent =j;
        (Instance.new ( "UICorner" ,o)).CornerRadius =UDim.new ( 0 , 6 )o.MouseButton1Click :Connect(w)
    end
    E( "自动偷蛋模式" , 10 )
    local S= false
    local Z=nil
    local z=nil Z=b( "自动偷蛋（平滑飞行）" , "飞向目标并自动将鸡蛋收入背包" ,h.pureTweenFarm ,Color3.fromRGB ( 0 , 195 , 255 ), 11 ,function(e,...)
        if S then
            return
        end
        if e then
    ...
    )z=b( "自动偷蛋（传送）" , "循环传送并收集鸡蛋" ,h.autoFarmLoop ,Color3.fromRGB ( 168 , 85 , 247 ), 12 ,function(e,...)
        if S then
            return
        end
        if e then
    ...
    A( "单次偷蛋（传送）" , "传送收集一个目标鸡蛋后返回" ,Color3.fromRGB ( 59 , 130 , 246 ), 13 ,function(...) task.spawn (function(...)
            if Y4~= "NONE" then
    ...
    )E( "放置鸡蛋" , 20 )A( "放置鸡蛋" , "返回基地，放置全部鸡蛋并孵化" ,Color3.fromRGB ( 16 , 215 , 130 ), 21 ,function(...) task.spawn (function(...) h.statusText = "[Manual] Depositing eggs..." g4(h.glideSpeed )v4()u4()h.isReturning = false h.delivering = false
        end
        )
    end
    )b( "自动放置（每5个）" , "每收集5个返回基地放置并等待5秒" ,h.autoPlaceEvery5 ,Color3.fromRGB ( 14 , 165 , 233 ), 22 ,function(e,...) h.autoPlaceEvery5 =e
        if not e then
            h.batchStealCount = 0
        end
    end
    )b( "自动孵化" , "持续自动孵化已准备好的鸡蛋" ,h.autoHatch ,Color3.fromRGB ( 16 , 185 , 129 ), 22 ,function(e,...) h.autoHatch =e
    end
    )b( "自动返回" , "偷蛋后自动返回安全区域" ,h.autoGlide ,Color3.fromRGB ( 245 , 158 , 11 ), 23 ,function(e,...) h.autoGlide =e
    end
    )b( "自动跑步机" , "没有目标鸡蛋时使用基地跑步机" ,h.autoTreadmill ,Color3.fromRGB ( 168 , 85 , 247 ), 24 ,function(e,...) h.autoTreadmill =e x()n4()
        if not e and((h.onTreadmill or L4()))then
            M4()
        end
    end
    )E( "角色与安全" , 30 )b( "无敌模式" , "抵御攻击和守卫" , false ,Color3.fromRGB ( 244 , 63 , 94 ), 31 ,function(e,...)
        if e then
            enableDesyncGodmode()
        else
    ...
    )A( "离开跑步机" , "立即脱离跑步机或装备" ,Color3.fromRGB ( 249 , 115 , 22 ), 32 ,function(...) pcall(M4)pcall(C4)pcall(D4)
    end
    )E( "控制与设置" , 40 )
    local F=Instance.new ( "Frame" )F.Size =UDim2.new ( 1 , 0 , 0 , 48 )F.BackgroundColor3 =t F.LayoutOrder = 41 F.Parent =n;
    (Instance.new ( "UICorner" ,F)).CornerRadius =UDim.new ( 0 , 8 )
    local O=Instance.new ( "TextLabel" )O.Size =UDim2.new ( 1 , -130 , 0 , 18 )O.Position =UDim2.new ( 0 , 10 , 0 , 6 )O.BackgroundTransparency = 1 O.Text = "飞行速度" O.TextColor3 =B O.TextSize = 13 O.Font =Enum.Font.GothamBold O.TextXAlignment =Enum.TextXAlignment.Left O.AutoLocalize = false O.Parent =F
    ...
    )A( "重置角色状态" , "清除速度、推力与冻结状态" ,Color3.fromRGB ( 99 , 102 , 241 ), 42 ,function(...) pcall(D4)pcall(u4)
    end
    )A( "卸载脚本" , "关闭界面并停止全部后台循环" ,Color3.fromRGB ( 153 , 27 , 27 ), 43 ,function(...) aM()
    end
    )E( "鸡蛋筛选（区域与稀有度）" , 45 )
    ...
    local w4=Instance.new ( "TextLabel" )w4.Size =UDim2.new ( 1 , -50 , 0 , 18 )w4.Position =UDim2.new ( 0 , 10 , 0 , 6 )w4.BackgroundTransparency = 1 w4.Text =string.format ( "📍 目标区域（%d/12 已启用）" ,r4())w4.TextColor3 =Color3.fromRGB ( 0 , 220 , 255 )w4.TextSize = 13 w4.Font =Enum.Font.GothamBold w4.TextXAlignment =Enum.TextXAlignment.Left w4.AutoLocalize = false w4.Parent =e4
    local j4=Instance.new ( "TextLabel" )j4.Size =UDim2.new ( 1 , -50 , 0 , 16 )j4.Position =UDim2.new ( 0 , 10 , 0 , 26 )j4.BackgroundTransparency = 1 j4.Text = "点击展开或收起区域选择" j4.TextColor3 =J j4.TextSize = 10 j4.Font =Enum.Font.Gotham j4.TextXAlignment =Enum.TextXAlignment.Left j4.AutoLocalize = false j4.Parent =e4
    ...
    for e,r in ipairs(M)do
        ...
        u()y.MouseButton1Click :Connect(function(...)
            ...
            h.selectedZones [r]=not((h.selectedZones [r]== true ))u()x()w4.Text =string.format ( "📍 目标区域（%d/12 已启用）" ,r4())
        end
        )y.Parent =a4 V4[r]=y
    end
    ...
    local p4=Instance.new ( "TextLabel" )p4.Size =UDim2.new ( 1 , -50 , 0 , 18 )p4.Position =UDim2.new ( 0 , 10 , 0 , 6 )p4.BackgroundTransparency = 1 p4.Text =string.format ( "🥚 目标稀有度（%d/%d 已启用）" ,t4(),#X)p4.TextColor3 =Color3.fromRGB ( 255 , 180 , 0 )p4.TextSize = 13 p4.Font =Enum.Font.GothamBold p4.TextXAlignment =Enum.TextXAlignment.Left p4.AutoLocalize = false p4.Parent =s4
    local B4=Instance.new ( "TextLabel" )B4.Size =UDim2.new ( 1 , -50 , 0 , 16 )B4.Position =UDim2.new ( 0 , 10 , 0 , 26 )B4.BackgroundTransparency = 1 B4.Text = "点击展开或收起稀有度选择" B4.TextColor3 =J B4.TextSize = 10 B4.Font =Enum.Font.Gotham B4.TextXAlignment =Enum.TextXAlignment.Left B4.AutoLocalize = false B4.Parent =s4
    ...
    for e,r in ipairs(X)do
        ...
        u()y.MouseButton1Click :Connect(function(...)
            ...
            h.selectedRarities [r]=not((h.selectedRarities [r]== true ))u()x()p4.Text =string.format ( "🥚 目标稀有度（%d/%d 已启用）" ,t4(),#X)
        end
        )y.Parent =K4
    end
...
H( "[+] Initializing Turok Hub x WindUI v42.64 (Steal an Egg Edition)..." )oM()task.spawn (function(...) task.wait ( 0.5 )A4()b4( true )C4()
    if o.Character then
        z4(o.Character )
    end
...
H( "[+] Turok Hub v42.64 Ready! All-In-One Built-in Anti-AFK & Prometheus Ready!" )